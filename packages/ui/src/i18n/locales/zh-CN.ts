...
const zhCN: Record<string, string> = {
  ...
  "settings.plugins.store.segment.skillsMarket": "Skills 市场",
  "settings.skillsMarket.subtitle": "从 SkillHub 搜索并安装技能，安装后可通过 / 命令使用。",
  "settings.skillsMarket.searchPlaceholder": "搜索技能，例如 pdf、xlsx",
  "settings.skillsMarket.search": "搜索",
  "settings.skillsMarket.searching": "搜索中...",
  "settings.skillsMarket.searchEmpty": "没有找到匹配的技能",
  "settings.skillsMarket.searchHint": "输入关键词开始搜索。",
  "settings.skillsMarket.installedBadge": "已安装",
  "settings.skillsMarket.install": "下载",
  "settings.skillsMarket.update": "更新",
  "settings.skillsMarket.installing": "安装中...",
  "settings.skillsMarket.updating": "更新中...",
  "settings.skillsMarket.installSuccess": "已安装「{name}」，可通过 / 命令使用。",
  "settings.skillsMarket.updateSuccess": "已更新「{name}」。",
  "settings.skillsMarket.installFailed": "安装失败：{message}",
  "settings.skillsMarket.updateConflict": "「{name}」存在本地改动，已跳过覆盖。",
  "settings.skillsMarket.version": "版本 {version}",
  "settings.skillsMarket.source": "来源：{source}",
  "settings.skillsMarket.noDescription": "暂无描述",
  "settings.skillsMarket.localChanges": "有本地改动",
  "settings.skillsMarket.cliMissing.title": "未检测到 skillhub CLI",
  "settings.skillsMarket.cliMissing.description":
    "Skills 市场依赖 SkillHub 官方 CLI。请先在终端执行以下命令安装，然后重新打开本页。",
  "settings.skillsMarket.cliVersion": "skillhub {version}",
  "settings.skillsMarket.installed.title": "已安装技能",
  "settings.skillsMarket.installed.empty": "还没有安装任何技能。",
  "settings.skillsMarket.refresh": "刷新",
  ...
  // 工作模式（mode list）：紧邻模型选择；每种模式自带提示词，切换后下一轮生效。
  "chat.toolbar.workMode.label": "工作模式",
  "agentWorkMode.coding": "编码",
  "agentWorkMode.coding.description": "在现有代码库中交付正确、可维护、可验证的改动。",
  "agentWorkMode.ui-design": "界面设计",
  "agentWorkMode.ui-design.description": "面向界面、视觉与组件的设计工作流。",
  "agentWorkMode.pentest-authorized": "渗透·已授权",
  "agentWorkMode.pentest-authorized.description": "仅在明确授权范围内开展安全评估，全程留痕。",
  // CUA 输入框常驻入口按钮
