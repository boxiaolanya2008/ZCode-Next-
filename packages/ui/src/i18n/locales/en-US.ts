...
const enUS: Record<string, string> = {
  ...
  "settings.plugins.store.segment.skillsMarket": "Skills Market",
  "settings.skillsMarket.subtitle":
    "Search and install skills from SkillHub. Installed skills are available via the / command.",
  "settings.skillsMarket.searchPlaceholder": "Search skills, e.g. pdf, xlsx",
  "settings.skillsMarket.search": "Search",
  "settings.skillsMarket.searching": "Searching...",
  "settings.skillsMarket.searchEmpty": "No matching skills found",
  "settings.skillsMarket.searchHint": "Enter a keyword to start searching.",
  "settings.skillsMarket.installedBadge": "Installed",
  "settings.skillsMarket.install": "Download",
  "settings.skillsMarket.update": "Update",
  "settings.skillsMarket.installing": "Installing...",
  "settings.skillsMarket.updating": "Updating...",
  "settings.skillsMarket.installSuccess": "Installed \"{name}\". It is now available via the / command.",
  "settings.skillsMarket.updateSuccess": "Updated \"{name}\".",
  "settings.skillsMarket.installFailed": "Install failed: {message}",
  "settings.skillsMarket.updateConflict": "\"{name}\" has local changes; update was skipped.",
  "settings.skillsMarket.version": "Version {version}",
  "settings.skillsMarket.source": "Source: {source}",
  "settings.skillsMarket.noDescription": "No description",
  "settings.skillsMarket.localChanges": "Local changes",
  "settings.skillsMarket.cliMissing.title": "skillhub CLI not found",
  "settings.skillsMarket.cliMissing.description":
    "The Skills Market relies on the official SkillHub CLI. Install it in a terminal with the command below, then reopen this page.",
  "settings.skillsMarket.cliVersion": "skillhub {version}",
  "settings.skillsMarket.installed.title": "Installed skills",
  "settings.skillsMarket.installed.empty": "No skills installed yet.",
  "settings.skillsMarket.refresh": "Refresh",
  ...
  // Work mode (mode list): sits next to model selection; each mode ships its own prompt, effective next turn.
  "chat.toolbar.workMode.label": "Work mode",
  "agentWorkMode.coding": "Coding",
  "agentWorkMode.coding.description": "Deliver correct, maintainable, verifiable changes in an existing codebase.",
  "agentWorkMode.ui-design": "UI design",
  "agentWorkMode.ui-design.description": "A design workflow for interfaces, visuals and components.",
  "agentWorkMode.pentest-authorized": "Pentest (authorized)",
  "agentWorkMode.pentest-authorized.description": "Security assessment strictly within the authorized scope, fully logged.",
